...
LORAS_DIR = os.getenv("LORA_DIR")
CHECKPOINTS_DIR = os.getenv("CHECKPOINT_DIR")
TEXTUALINVERSIONS_DIR = os.getenv("TEXTUALINVERSION_DIR")
HYPERNETWORKS_DIR = os.getenv("HYPERNETWORK_DIR")
AESTHETICGRADIENTS_DIR = os.getenv("AESTHETICGRADIENT_DIR")
CONTROLNETS_DIR = os.getenv("CONTROLNET_DIR")
POSES_DIR = os.getenv("POSES_DIR")

MODEL_DIRS = {
    "LORA": LORAS_DIR,
    "CHECKPOINT": CHECKPOINTS_DIR,
    "TEXTUALINVERSION": TEXTUALINVERSIONS_DIR,
    "HYPERNETWORK": HYPERNETWORKS_DIR,
    "AESTHETICGRADIENT": AESTHETICGRADIENTS_DIR,
